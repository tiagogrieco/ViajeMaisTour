...
import { Trash2, Edit, Plus, Search, FileText, User, Calendar, DollarSign } from 'lucide-react';
...
export const CotacoesTab: React.FC<CotacoesTabProps> = ({ cotacoes, setCotacoes, clientes, produtos }) => {
                ...
                <div className="space-y-3">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                    ...
                    {cotacao.dataVencimento && (
                      <div>
                        <strong>Vencimento:</strong> {formatDate(cotacao.dataVencimento)}
                      </div>
                    )}
                  </div>
